...
def session(me):
	...
	for i in xrange(len(items)):
		exposePicture.append("http://tedlab.mit.edu/~mekline/MDPictures/" + verb[i] + "_" + trialVersion[i] + ".jpg")
		actionPicture.append("http://tedlab.mit.edu/~mekline/MDPictures/" + verb[i] +".jpg")
